...
class MusicPlayer:
    ...
    def __init__(self,root):
        self.root = root
    # Title of the window
        self.root.title("Music Player Application using Python:PyGame")
        # Window Geometry
        ...
        trackframe = LabelFrame(self.root,text="Song Track",font=("times new roman",15,"bold"),bg="Cadet blue",fg="white",bd=5,relief=GROOVE)
        ...
        for track in songtracks:   #create a list BOX
    ...
    def playsong(self):
        ...
        pygame.mixer.music.load(self.playlist.get(ACTIVE))   #PYGAME PLAYS THE SONGS FROM MUSIC
